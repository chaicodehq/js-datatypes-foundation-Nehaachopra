...
export function findPassenger(passengers, name) {
  // Your code here
  if (!Array.isArray(passengers)|| passengers.length === 0 || typeof name !== "string" || name.trim() === "") return undefined
...
export function getPassengerIndex(passengers, name) {
  // Your code here
  if (!Array.isArray(passengers)|| passengers.length === 0 || typeof name !== "string" || name === "") return -1;
